...
ELSE(WIN32)
	...
	set(NITE_LIB_SEARCH_PATHS "${NITE_LIB_SEARCH_PATHS}" "/usr/local/lib64" "/usr/lib64")
ENDIF(WIN32)
...
if(NITE_INCLUDE_DIR STREQUAL "NITE_INCLUDE_DIR-NOTFOUND")
	...
	find_path(NITE_INCLUDE_DIR NAMES NiTE.h 
	  PATH_SUFFIXES "NiTE2"
	)
else()
	message(STATUS "NiTE found: " ${NITE_INCLUDE_DIR})
endif()
...
message(STATUS "NiTE lib: " ${NITE_LIBRARY})
